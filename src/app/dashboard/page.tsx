      ...
      <div className="min-h-screen bg-gray-50 dark:bg-zinc-950">
        ...
        <div className="max-w-6xl mx-auto px-6 py-10">
          <div className="flex justify-between items-end mb-10">
            ...
            <Link
              href="/create"
              className="flex items-center gap-3 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-medium"
            >
          ...
          {loading && <Loader />}
          {error && (
            <div className="text-red-500 p-4 bg-red-50 dark:bg-red-950 rounded-xl">
              {error}
            </div>
          )}
